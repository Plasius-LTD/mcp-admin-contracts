# ADR 0005: Privacy-Safe Read-Only Feedback Contract
...
`2026-08-11.v6`. It contains five read-only descriptors:
...
The global AI-plugin manifest retains the current
`openid email profile mcp:access` base scopes. Publishing `admin.feedback.read` there before the site issuer,
